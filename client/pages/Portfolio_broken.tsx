...
const Portfolio = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-900 overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-slate-900/95 backdrop-blur-xl border-b border-slate-700/50 transform-3d" role="navigation" aria-label="Main navigation">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="text-2xl font-bold text-white hover:scale-110 transition-all duration-500 cursor-pointer transform-3d">
              <Sparkles className="inline w-6 h-6 mr-2 text-blue-400 animate-pulse hover:animate-spin transition-all duration-500" aria-hidden="true" />
                    ...
                    <div className="absolute inset-12 rounded-full overflow-hidden border-4 border-slate-600 shadow-2xl hover:shadow-blue-500/50 transition-all duration-1000 hover:scale-110 hover:rotate-3 transform-3d">
                      <img
                       src="/images/my_pic.jpeg"
                        alt="Professional photo of Akshit Bhardwaj, AI/ML Engineer"
